...
const temp=document.getElementById('nav-id')

const showup=document.getElementById('scroll-up')

window.addEventListener('scroll',function(){
    if(window.pageYOffset>20)
    {
        temp.className="mynav stickya";
    }
    else{
        temp.className="mynav";
    }

    if(window.pageYOffset>500)
    {
        showup.className="scroll-up-btn show"
    }
    else{
        showup.className="scroll-up-btn"
    }
})
